    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(help_text='If anything noteworthy happened during acquisition, it may be noted here.', max_length=1000)),
                ('is_updated_from_dicom', models.BooleanField(default=False)),
                ('_nifti', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='mri.NIfTI')),
                ('dicom', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='django_dicom.Series', verbose_name='DICOM Series')),
                ('sequence_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='mri.SequenceType')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='research.Subject')),
            ],
            options={
