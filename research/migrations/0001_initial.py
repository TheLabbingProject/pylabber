# Generated by Django 2.1 on 2018-08-05 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dominant_hand', models.CharField(blank=True, choices=[('RIGHT', 'Right'), ('LEFT', 'Left'), ('AMBI', 'Ambidextrous')], default=research.models.choices.DominantHand('Right'), max_length=5)),
                ('sex', models.CharField(blank=True, choices=[('MALE', 'Male'), ('FEMALE', 'Female'), ('OTHER', 'Other')], max_length=6)),
                ('gender', models.CharField(blank=True, choices=[('CIS', 'Cisgender'), ('TRANS', 'Transgender'), ('OTHER', 'Other')], default=research.models.choices.Gender('Cisgender'), max_length=5)),
            ],
        ),
        migrations.AddField(
            model_name='study',
